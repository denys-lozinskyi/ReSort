...
def if_dublicate_title(file_name, path2dest_folder):
    '''функция вызывается из title_maker в случае, если файл с таким именем уже присутствует в папке назначения.
       ...
       где n - нумератор повторений имени файла, целое число, начиная с 1,
    ...
    title_constructor.append(0) #добавляем в список нумератор повторений
