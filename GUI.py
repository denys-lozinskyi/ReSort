...
display1 = Listbox(window, width=55, height=25, bd=2, font=("Times New Roman", 12), yscrollcommand=scrollbar.set)
display1.place(x=300, y=80)

display2 = Listbox(window, width=55, height=25, bd=2, font=("Times New Roman", 12), yscrollcommand=scrollbar.set)
